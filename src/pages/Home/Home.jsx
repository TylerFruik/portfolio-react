      ...
      <div className="custom-container">
        <div className="segment">
          ...
          <div className="content" id="about-me-content">
            <p>I'm Tyler Fruik, a Freelance Web Developer, Live Broadcaster, 3d Model Artist, Audio Coach/Consultant, and Voice Over Artist. I received my education through the UT-Austin Full-Stack Web Development Bootcamp in which I earned the awards for "Best Front-End Developer" as well as "Best Single Day Programmer" graduating in March of 2024. My education also included several courses through the University of Wisconsin-Madison and Madison Area Technical College.</p>
            <p>In the months since my graduation, I have been diligently seeking out full time employment in web development. Be it front or back end, I have been ensuring my skills remain sharpened through commissions for custom web applications or homepages for various Austin based organizations. While the majority of my work in recent months has been independent, the greatest fulfillment through development has always been found alongside a team of peers. Every time, collaboration has served as the greatest springboard for inspiration while offering endless opportunities to grow each other's skills.</p>
