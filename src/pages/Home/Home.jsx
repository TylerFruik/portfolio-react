      ...
      <div className="custom-container">
        <div className="segment">
          ...
          <div className="content" id="about-me-content">
            ...
            <p>In the months since my graduation, I have been diligently seeking out full time employment in web development. Be it front or back end, I have been ensuring my skils remain sharpened through commissions for custom web applications or homepages for various Austin based organizations. While the majority of my work in recent months has been independent, the greatest fulfillment through development has always been found alongside a team of peers. Every time, collaboration has served as the greatest springboard for inspiration while offering endless opportunities to grow each other's skills.</p>
